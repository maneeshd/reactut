            ...
            <Row className="text-center justify-content-center align-content-center">
                <Col md="auto">
                    <InputGroup size="sm" className="my-1 mx-0">
                        <InputGroupAddon className="shadow-sm" addonType="prepend">&#128270;</InputGroupAddon>
                        <Input placeholder="Search Expense" type="text" className="shadow-sm" value={this.props.filters.text} onChange={(e) => (
                ...
                <Col md="auto">
                    <InputGroup size="sm" className="my-1 mx-0">
                        <InputGroupAddon className="shadow-sm" addonType="prepend">Sort by</InputGroupAddon>
                        <Input type="select" className="shadow-sm" defaultValue="date" onChange={(e) => {
                ...
                <Col md="auto">
                    <InputGroup size="sm" className="my-1 mx-0">
                        <InputGroupAddon className="shadow-sm" addonType="prepend">&#8645;</InputGroupAddon>
                        <Input type="select" className="shadow-sm" defaultValue="asc" onChange={(e) => {
                ...
                <Col md="auto">
                    <InputGroup size="sm" className="my-1 mx-0">
                        <InputGroupAddon className="shadow-sm" addonType="prepend">From</InputGroupAddon>
                        <DatePicker
                ...
                <Col md="auto">
                    <InputGroup size="sm" className="my-1 mx-0">
                        <InputGroupAddon className="shadow-sm" addonType="prepend">To</InputGroupAddon>
                        <DatePicker
